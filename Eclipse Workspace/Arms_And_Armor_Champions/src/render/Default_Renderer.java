...
public class Default_Renderer extends Renderer {
    ...
    public void render(ShapeRenderer triangleBatch, SpriteBatch batch) {
        ...
        if(AAA_C.debug){
        	drawPolygon(triangleBatch, polTestArray, 400, 0, Color.YELLOW);
        	drawPolygon(triangleBatch, testCell.getPolygons(), -500, 200, Color.YELLOW);
        }
        float[] verts3 = {100, 200, 100, 300, 0, 300, 123, 102};
        drawPolygon(triangleBatch, verts3, 0, 0, Color.BLUE);
    }
