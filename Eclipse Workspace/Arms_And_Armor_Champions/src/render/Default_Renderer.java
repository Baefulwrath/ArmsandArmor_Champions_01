...
public class Default_Renderer extends Renderer {
    ...
    public void render(SpriteBatch batch) {
        ...
        drawString(batch, "ESC to quit, F1 to return to menus.", (int) getScreenX(), (int) -getScreenY() - 10, com10, Color.RED, false);
        drawString(batch, "DEFAULT RENDERER", (int) getScreenX(), (int) getScreenY(), com16, Color.RED, false);
        drawString(batch, "+", (int) AAA_C.inputhandler.mouse.x, (int) AAA_C.inputhandler.mouse.y, com16, Color.CYAN, true);
    }
